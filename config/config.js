...
module.exports = {
  ...
  "SITE_URL": process.env.SITE_URL || "https://bitcrash.us",
  ...
  "RECAPTCHA_PRIV_KEY": process.env.RECAPTCHA_PRIV_KEY || '6Lfr4GAUAAAAKDARkFrZW2ABmalTaC6G9q4raL8z',
  "RECAPTCHA_SITE_KEY": process.env.RECAPTCHA_SITE_KEY || '6Lfr4GAUAAAAKMQQrtCOXC8nnVtvJaP6YBa1qa3w',
