define(['lib/key-mirror'], function(KeyMirror){
    ...
    return {
        ...
        Engine: {
            ...
            HOST: (window.document.location.host === 'www.bitcrash.us' || window.document.location.host === 'bitcrash.us' || window.DEV_OTT) ? 'https://gs.bitcrash.us:2083' : window.document.location.host.replace(/:2053$/, ':2083'),
